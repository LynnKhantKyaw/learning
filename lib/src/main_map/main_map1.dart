          ...
          children: [
            Stack(
              children: [
                ...
                titleSubject("စိုက်ပျိုးဂေဟစနစ်ဆိုင်ရာ \nအလေ့အထများ", 490, 70),
                            ...
                            Row(
                              children: [
                                Image.asset("assets/images/ic_trophy.png",
                                    width: 18,
                                    color:
                                        const Color.fromARGB(255, 82, 57, 59)),
                                const SizedBox(
                                  width: 4,
                                ),
                                Image.asset("assets/images/ic_trophy.png",
  ...
  Widget subjectText(
    ...
    return Positioned(
      ...
      child: GestureDetector(
        ...
        onTap: () {
          Navigator.push(context,
              MaterialPageRoute(builder: (context) => const LearningPage0()));
        },
        child: Container(
          padding: const EdgeInsets.only(left: 12),
          alignment: Alignment.centerLeft,
          ...
          onPressed: () async {
            Future.delayed(const Duration(milliseconds: 800), () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => const LearningPage0()));
            });
          },
          child: Image.asset(
            image,
